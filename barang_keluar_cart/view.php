                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-footer">
                            <form method="post" action="../barang_keluar/index.php">
                                <input type="hidden" name="total_harga" class="total_harga" id="total_harga" value="<?= $total ?>">
                                <div class="form-group">
                                    <label>Nama Pelanggan</label>
                                    <select name="pelanggan_id" class="form-control pelanggan_id" id="pelanggan_id" required>
                                        <option value="">-- Pilih Nama Pelanggan --</option>
                                        <?php
                                        $sql = "SELECT * from pelanggan";
                                        $query_pelanggan = mysqli_query($conn, $sql);
                                        while ($pelanggan = $query_pelanggan->fetch_object()) { ?>
